...
[Change [exec.split]{.sref} para 3 and insert a new para after 3 as follows:]{.ednote}
...
> [?]{.pnum} The exposition-only class template _`impls-for`_ ([exec.snd.general]{.sref}) is
