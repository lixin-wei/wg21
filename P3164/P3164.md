...
* Remove section respecifying `transform_completion_signatures` to propagate
   type errors. A separate paper
   ([P3557](https://isocpp.org/files/papers/P3557R0.html)) addresses the
   issue of type errors during the computation of completion signatures.
